                ...
                <div class="card-header-pemetaan text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title-pemetaan">
                            <i class="fas fa-globe me-2"></i> Pemetaan Kebun Saya
                        </h4>
                        <div class="d-flex align-items-center gap-3">
                            <!-- Tab Navigation -->
                            <ul class="nav nav-tabs mb-0" id="viewTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="{{ route('pekebun.pemetaan.map') }}">
                                        <i class="fas fa-map me-1"></i> Map
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="{{ route('pekebun.pemetaan.table') }}">
                            ...
                            <div class="col-xl-4">
                                <aside class="sidebar-card">
                                    ...
                                    <div class="user-info-card">
                                        ...
                                        <div class="user-role">Pekebun</div>
                                        <small>Total Kebun: <strong id="totalKebunUser">0</strong></small>
                                    </div>
                                    ...
                                    <div class="sidebar-section">
                                        <h5><i class="fas fa-chart-pie me-2"></i>Statistik Kebun Saya</h5>
                                        <div class="row g-2">
                                            <div class="col-6">
                                            ...
                                            <div class="col-6">
                                                <div class="stat-card-modern">
                                                    ...
                                                    <div class="count" id="prosesCount">0</div>
                                            ...
                                            <div class="col-6">
                                                <div class="stat-card-modern">
                                                    ...
                                                    <div class="count" id="perbaikanCount">0</div>
                                            ...
                                            <div class="col-6">
                                                <div class="stat-card-modern">
                                                    ...
                                                    <div class="count" id="totalLuas">0</div>
...
<script>
    ...
    function getFeatureStyle(properties) {
        ...
        if (type === "Kebun Sawit") {
            const key = currentLayerStyle === "status_ispo" ? properties.statusISPO : properties.tingkatKesiapan;
            const colorMap = {
                status_ispo: { 
                    "Lulus": "#28a745", 
            ...
            color = colorMap[currentLayerStyle][key] || color;
    ...
    // Fungsi untuk konversi koordinat GeoJSON ke Leaflet
    function convertCoordinates(coords, geometryType) {
        if (geometryType === "point") {
            ...
            // Ambil ring pertama (exterior ring)
    ...
    function initMap() {
        // Set view ke Labuhan Tangga Baru, Rohil
    ...
    function updateFeatures() {
                ...
                if (feature) {
                    ...
                    const popupContent = `
                        <div class="p-2" style="min-width: 200px;">
                            ...
                            ${p.tingkatKesiapan !== "N/A" ? `<p class="mb-1 small"><strong>Tingkat Kesiapan:</strong> ${p.tingkatKesiapan}</p>` : ""}
                        </div>
                    `;
                    
                    feature.bindPopup(popupContent);
                    feature.on("click", () => zoomToFeature(data.id));
        ...
        // Auto-fit map ke semua features jika ada
    ...
    function zoomToFeature(id) {
        const data = gisData.find((d) => d.id === id);
        if (!data || !map) return;
    ...
    // Function untuk focus ke feature tertentu jika ada parameter
    ...
    // Event listener untuk radio button layer
